...
export default function Page() {
  return (
    <RecursoLista<Ubicacion>
      ...
      columnas={columnas}
      accionFila={(ubicacion) => (
        <FormDialog recurso="Ubicación" descripcion="Punto geográfico con coordenadas para rutas y manifiestos." endpoint="/ubicaciones" registroId={ubicacion.id} campos={campos} />
      )}
      acciones={
        <FormDialog
          recurso="Ubicación"
...
const campos: CampoForm[] = [
  ...
  { name: "tipo", label: "Tipo", tipo: "select", opciones: [{ valor: "BASE", etiqueta: "Base" }, { valor: "ORIGEN", etiqueta: "Origen" }, { valor: "DESTINO", etiqueta: "Destino" }, { valor: "PUESTO_CONTROL", etiqueta: "Puesto de control" }, { valor: "SUCURSAL", etiqueta: "Sucursal" }, { valor: "GENERAL", etiqueta: "General" }] },
