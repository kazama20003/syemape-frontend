    ...
    <div className="flex flex-col gap-4 p-4 lg:p-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Recursos corporativos de MAPE. Las unidades son activos vehiculares con su propio detalle operativo.{isFetching && !isLoading && <span className="ml-2 text-xs">Actualizando...</span>}</p>
        </div>
        <ActivoForm />
      </div>
