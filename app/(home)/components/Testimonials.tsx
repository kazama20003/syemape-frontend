...
export default function Testimonials() {
  ...
  return (
    <>
<section className="testimonials_wrap u-section u-theme-dark relative overflow-clip rounded-xl u-container py-14 md:py-16">
<div data-parallax="trigger" data-parallax-start="-35" data-parallax-end="0" className="parallax_section_bg_wrap">
<img src="data:image/svg+xml;base64," alt="" className="h-full w-full object-cover" loading="lazy"/>
</div>
<div className="absolute inset-0 bg-[#3a2a33]/40">
</div>
<div className="relative grid md:grid-cols-[16%_1fr]" data-slider="component">
<p className="eyebrow">Patient testimonials</p>
<div>
<div className="flex items-end justify-between">
<h2 className="text-[length:var(--text-fluid-h4)]">What Patients Share</h2>
...
>
<figure className="swiper-slide glass-dark flex min-h-[9.375rem] flex-col justify-between rounded-lg p-4 transition-colors duration-500 hover:bg-black/40">
