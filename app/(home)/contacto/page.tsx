    ...
    <main className="bg-[#f7f5f1] text-dark">
      <section className="grid min-h-[100svh] lg:grid-cols-[minmax(23rem,1fr)_minmax(35rem,1fr)]">
        <div className="relative min-h-[34rem] overflow-hidden bg-[#263e42] text-white">
          <div className="flex h-full min-h-[34rem] flex-col justify-end p-6 md:p-10 lg:p-14">
            <p className="eyebrow">S&amp;E MAPE E.I.R.L.</p>
            <h1 className="mt-5 max-w-[13ch] text-[clamp(2.5rem,5vw,5.5rem)] leading-[0.94]">Rutas seguras, decisiones claras.</h1>
            <p className="mt-7 max-w-sm text-sm leading-relaxed text-white/80">SUPERVISIÓN CON EXPERIENCIA PARA RUTAS SEGURAS</p>
          </div>
        </div>
        ...
        <div className="flex items-center px-[var(--spacing-gutter)] py-28 lg:px-[clamp(3rem,7vw,8rem)]">
          <div className="w-full max-w-3xl">
            ...
            <h2 className="mt-5 text-[length:var(--text-fluid-h2)]">Cuéntanos sobre tu operación.</h2>
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-dark/70">Nuestro equipo te responderá para coordinar el servicio de transporte, escolta o supervisión que necesitas.</p>

            <form className="mt-10 grid gap-x-7 gap-y-6 sm:grid-cols-2">
      ...
      <section className="bg-brand px-[var(--spacing-gutter)] py-12 text-white md:py-16">
        <div className="mx-auto grid max-w-[120rem] gap-10 border-y border-white/35 py-8 md:grid-cols-[1fr_1fr_1.4fr] md:gap-8">
          ...
          <p className="max-w-md text-sm leading-relaxed text-white/85">Atendemos requerimientos de minería, construcción e industria con una operación enfocada en seguridad y continuidad.</p>
        </div>
      </section>
    </main>
  );
